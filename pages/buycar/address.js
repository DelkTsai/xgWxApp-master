...
Page({
  ...
  onLoad: function (options) {
    ...
    var couponPrice = options.couponPrice;
  ...
  // 点击选择地址
  backToDetail: function (event) {
    console.log(event);
    var that = this;
    var addressId = event.currentTarget.dataset.addressId;
    var contactMobile = event.currentTarget.dataset.contactMobile;
    var contactPerson = event.currentTarget.dataset.contactPerson;
    var totalAddress = event.currentTarget.dataset.province + " " + event.currentTarget.dataset.city + " " + event.currentTarget.dataset.district + " " + event.currentTarget.dataset.address + " ";
    var orderNo = that.data.orderNo;
    var orderId = that.data.orderId;
    var couponPrice = that.data.couponPrice;
    var couponId = that.data.couponId;
    wx.redirectTo({
      url: 'orderFront?orderNo=' + orderNo + "&orderId=" + orderId + "&couponPrice=" + couponPrice + "&couponId=" + couponId + "&addressId=" + addressId + "&contactMobile=" + contactMobile + "&contactPerson=" + contactPerson + "&totalAddress=" + totalAddress,
    })
  }
})