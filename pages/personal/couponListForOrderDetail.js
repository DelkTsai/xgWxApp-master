...
Page({
  ...
  goToDetail:function(event)
  {
    ...
    formPage.data.couponResult = para;
    wx.navigateBack({
      
    });
    // wx.redirectTo({
    //   url: 'orderDetail?orderNo=' + orderNo + "&orderId=" + orderId + "&couponPrice=" + price + "&couponId=" + couponId + "&addressId=" + getAddressId + "&contactMobile=" + contactMobile + "&contactPerson=" + ordercontactPerson + "&totalAddress=" + getAddress,
    // })
  }
})