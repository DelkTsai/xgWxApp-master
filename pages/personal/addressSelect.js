...
Page({
  ...
  onLoad: function (options) {
    ...
    var goodsAttr = options.goodsAttr;
    that.setData({
      goodsId: goodsId,//从弹出窗传递过来的参数
      goodsName: goodsName,
      goodsImg: goodsImg,
      goodsAttr: goodsAttr
    })
  ...
  giveToConfirm: function (event) {
    ...
    var goodsAttr = that.data.goodsAttr;
      wx.navigateTo({
        url: 'pieceConfirm?addressId=' + addressId + "&contactMobile=" + contactMobile +"&contactPerson="+contactPerson+
        "&province=" + province + "&city=" + city + "&district=" + district + "&address=" + address + "&goodsId=" + goodsId+
        "&goodsImg=" + goodsImg + "&goodsName=" + goodsName + "&goodsAttr=" + goodsAttr
      })
  }
})