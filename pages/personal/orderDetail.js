...
Page({
      ...
      if (getCouponId=="")
      {
        if (getCouponPrice == "" && json.data.couponStatus == "0") {
          ...
          that.setData({
            ...
            getCouponPrice: json.data.couponPrice,
          });
        }
      }
      else if (getCouponId != "")
  ...
  getAddress:function()
  {
    ...
    var getCouponId = that.data.getCouponId;
    wx.navigateTo({
      url: 'addressForOrderDetail?orderNo=' + orderNo + "&orderId=" + orderId + "&couponPrice=" + getCouponPrice + "&couponId=" + getCouponId,
    })
  },
  //没有优惠券获取优惠券
  getCoupon:function()
  {
    ...
    var getAddressId = that.data.getAddressId;
    wx.navigateTo({
      url: 'couponListForOrderDetail?orderNo=' + orderNo + "&orderId=" + orderId + "&getAddressId=" + getAddressId + "&getAddress=" + getAddress + "&contactPerson=" + contactPerson + "&contactMobile=" + contactMobile,
    })
  },
  // 是否使用余额开关
